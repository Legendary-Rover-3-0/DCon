...
#define ABSOLUTE_ENCODER_CLOCK_IN_SPI_Pin GPIO_PIN_5
#define ABSOLUTE_ENCODER_CLOCK_IN_SPI_GPIO_Port GPIOA
#define ABSOLUTE_ENCODER_DATA_OUT_SPI_Pin GPIO_PIN_6
#define ABSOLUTE_ENCODER_DATA_OUT_SPI_GPIO_Port GPIOA
