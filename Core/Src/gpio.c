...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(BLDC_MOTOR_CONTROLLER_F_R_GPIO_OUT_GPIO_Port, BLDC_MOTOR_CONTROLLER_F_R_GPIO_OUT_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : BLDC_MOTOR_CONTROLLER_F_R_GPIO_OUT_Pin */
  GPIO_InitStruct.Pin = BLDC_MOTOR_CONTROLLER_F_R_GPIO_OUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(BLDC_MOTOR_CONTROLLER_F_R_GPIO_OUT_GPIO_Port, &GPIO_InitStruct);
