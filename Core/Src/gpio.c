...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, BLDC_MOTOR_CONTROLLER_F_R_GPIO_OUT_Pin|CAN_RS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : BLDC_MOTOR_CONTROLLER_F_R_GPIO_OUT_Pin CAN_RS_Pin */
  GPIO_InitStruct.Pin = BLDC_MOTOR_CONTROLLER_F_R_GPIO_OUT_Pin|CAN_RS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
