...
{
    [RIGHT_FRONT] = {ID_RIGHT_FRONT_STEPPERMOTOR, ID_RIGHT_FRONT_BLDC, ID_RIGHT_FRONT_INC_ENCODER},
    [LEFT_FRONT]  = {ID_LEFT_FRONT_STEPPERMOTOR,  ID_LEFT_FRONT_BLDC,  ID_LEFT_FRONT_INC_ENCODER},
    [RIGHT_REAR]  = {ID_RIGHT_REAR_STEPPERMOTOR,  ID_RIGHT_REAR_BLDC,  ID_RIGHT_REAR_INC_ENCODER},
    [LEFT_REAR]   = {ID_LEFT_REAR_STEPPERMOTOR,   ID_LEFT_REAR_BLDC,   ID_LEFT_REAR_INC_ENCODER},
};
